...
library_name=$(cat $temp_directory/LIBRARY_AWS_NAME)
library_version=$(cat $temp_directory/LIBRARY_AWS_VERSION)
...
sed 's/@_LIBRARY_AWS_NAME_@/'$library_name'/'       | \
sed 's/@_LIBRARY_AWS_VERSION_@/'$library_version'/' | \
